    ...
    Rectangle {
        ...
        Grid {
            ...
            Text {
                ...
                text: "<table>"
                        + "<tr><td><b>" + i18n("Checked") + "</b>: </td> <td style='padding-bottom:6px'>" + i18n("Hides the display when '0' traffic is reported.  Displays will become vsible again when traffic starts to flow.") + "</td></tr>"
